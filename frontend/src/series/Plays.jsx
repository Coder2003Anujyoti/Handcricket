...
<HashLink smooth to={`/onlines?id=${encodeURIComponent(name)}&&player=${encodeURIComponent(i.firstteam.name)}&&playerteam=${encodeURIComponent(i.firstteam.team)}&&computerteam=${encodeURIComponent(i.secondteam.team)}&&matchID=${encodeURIComponent(id)}`}>
