...
<p className="text-center text-sm text-white font-bold">Group Stage</p>
...
}
{
  ...
  <div className="flex flex-col ml-2 mr-2 gap-4 my-3 md:my-6 lg:px-20 lg:ml-16 md:ml-6 md:justify-center md:gap-8 md:items-center lg:gap-10 lg:flex-row lg:flex-wrap">
   <div className="w-full bg-slate-800 flex flex-col p-2 rounded-md flex-wrap lg:w-96 lg:h-48 md:w-96 md:h-48 md:p-2">
  <div className="h-1/2 flex flex-row items-center justify-center">
  <img src={teamicons.filter((i)=> i.team == val[0].contestants[0].team)[0].image} className="w-20 h-20 " />
  <img src={teamicons.filter((i)=> i.team == val[0].contestants[1].team)[0].image} className="w-20 h-20 " />
  <img src={teamicons.filter((i)=> i.team == val[0].contestants[2].team)[0].image} className="w-20 h-20 " />
  <img src={teamicons.filter((i)=> i.team == val[0].contestants[3].team)[0].image} className="w-20 h-20 " />
  </div>
   <div className="h-1/2 flex flex-col items-center justify-center p-2  gap-1">
   <img src="Icons/trophy.webp" className="w-8 h-8 "/>
   <p className="text-sm text-white font-bold">🏆 The Battle Begins! 4 Teams. 1 Champion.One Dream.Four Teams.💥 Let the tournament begin!</p>
   </div>
    </div>
    </div>
  </>
...
{mode== "result" && <>
{
 loading==false && val.length > 0 && (val[0].winner != "" && val[0].runnerup != "" && val[0].thirdplace != "")  &&
  <>
 <Confetti
      width={window.innerWidth}
      height={window.innerHeight}
